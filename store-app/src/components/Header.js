                              ...
                              <div className="row">
                                   <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                                        <ul className="topnav">
                                             ...
                                             <li className="checkout hidden-xs hidden-sm"><Link to="/Checkout">0 items | Checkout</Link></li>
                         ...
                         <div className="container">
                              <div className="row">
                                   <div className="col-md-6 col-lg-6 hidden-xs hidden-sm">
                                        <input type="text" className="searchbar"/><button type="submit" className="subbtn"><i className="fas fa-search"></i></button>
                                   </div>
                              </div>
                         </div>
                    </div>
